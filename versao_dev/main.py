...
if __name__ == '__main__':
    ...
    ground = Entity(model='models/terrain_simple', scale=(1,1,1), texture = 'models/texture/dirt', collider = 'box')
    stone = Entity(model='models/stone1', scale=(.05,.05,.05), position =(3.5,1,3), texture = 'models/texture/stone', collider = 'mesh')
    ...
    player = Player(model='hourglass', scale=(0.01,0.01,0.01), position = (0,.5,0), collider='box', color=color.gray.tint(-.2))
